...
const Play = ({ color, secondaryColor, strokeWidth, opacity, set, }) => {
    ...
    const Curved = () => (<G transform="translate(2 2)">
      ...
      <Path d="M5.513,3.338c0-.9-4.584-3.8-5.1-3.276s-.57,5.983,0,6.552S5.513,4.242,5.513,3.338Z" transform="translate(7.903 6.517)" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" strokeWidth={strokeWidth}/>
    </G>);
    switch (set) {
        case 'bold':
            return <Bold />;
