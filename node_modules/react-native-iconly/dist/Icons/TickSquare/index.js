...
const TickSquare = ({ color, secondaryColor, strokeWidth, opacity, set, }) => {
    ...
    const Bulk = () => (<G transform="translate(2 2)">
      ...
      <Path d="M3.249,6.5a.872.872,0,0,1-.619-.256L.257,3.868A.875.875,0,0,1,1.493,2.629L3.249,4.385,7.377.257A.875.875,0,0,1,8.613,1.495L3.868,6.24a.872.872,0,0,1-.619.256" transform="translate(5.565 6.752)" fill={color}/>
    </G>);
