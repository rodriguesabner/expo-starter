...
const PaperUpload = ({ color, secondaryColor, strokeWidth, opacity, set, }) => {
    ...
    const Bulk = () => (<G transform="translate(3.5 2)">
      ...
      <Path d="M6.995,4.147a.745.745,0,0,1-1.054,0l-1.589-1.6V7.375a.745.745,0,1,1-1.489,0V2.548l-1.591,1.6A.745.745,0,0,1,.217,3.094L3.079.219h0a.745.745,0,0,1,.815-.16.753.753,0,0,1,.238.159s0,0,0,0L7,3.094a.744.744,0,0,1,0,1.053" transform="translate(4.61 6.737)" fill={color}/>
    </G>);
    const Light = () => (<G transform="translate(3.5 2)">
      ...
      <Path d="M.5,0V6.573" transform="translate(7.641 7.441)" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" strokeWidth={strokeWidth}/>
      <Path d="M0,2.851,2.838,0,5.677,2.851" transform="translate(5.302 7.44)" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" strokeWidth={strokeWidth}/>
    </G>);
    const Broken = () => (<G transform="translate(3.5 2)">
      <Path d="M4.57,20A4.57,4.57,0,0,1,0,15.332V12.809a.748.748,0,1,1,1.5,0v2.523A3.048,3.048,0,0,0,4.57,18.49h7.963A3.11,3.11,0,0,0,15.5,15.332V6.383L11.687,2.368V3.685A1.832,1.832,0,0,0,13.5,5.522a.755.755,0,0,1,0,1.51h0a3.338,3.338,0,0,1-3.308-3.348V1.522H4.57a3.078,3.078,0,0,0-3.074,3V8.7a.752.752,0,0,1-.748.755A.752.752,0,0,1,0,8.7V4.522A4.6,4.6,0,0,1,4.57.012h6.312C10.9.01,10.92,0,10.939,0s.038.01.058.012h.2a.745.745,0,0,1,.54.233l5.05,5.312A.76.76,0,0,1,17,6.08v9.251A4.631,4.631,0,0,1,12.533,20Zm2.8-5.89V9.319L5.816,10.895a.743.743,0,0,1-1.058,0,.762.762,0,0,1,0-1.068l2.831-2.87h0a.745.745,0,0,1,1.058,0h0l2.831,2.87a.761.761,0,0,1,0,1.068.744.744,0,0,1-1.057,0L8.863,9.319v4.791a.748.748,0,1,1-1.5,0Z" fill={color}/>
    </G>);
    const TwoTone = () => (<G transform="translate(3.5 2)">
      <Path d="M10.486,0H3.834A3.82,3.82,0,0,0,0,3.729V14.466a3.806,3.806,0,0,0,3.834,3.887h7.988a3.867,3.867,0,0,0,3.73-3.887V5.276Z" transform="translate(0.75 0.762)" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" strokeWidth={strokeWidth}/>
      <Path d="M0,0V2.909A2.575,2.575,0,0,0,2.569,5.484c1.316,0,2.663,0,2.754,0" transform="translate(10.974 0.75)" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" strokeWidth={strokeWidth}/>
      <Path d="M.5,0V6.573" transform="translate(7.641 7.441)" fill="none" stroke={secondaryColor} strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" opacity={opacity} strokeWidth={strokeWidth}/>
      <Path d="M0,2.851,2.838,0,5.677,2.851" transform="translate(5.302 7.44)" fill="none" stroke={secondaryColor} strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" opacity={opacity} strokeWidth={strokeWidth}/>
    </G>);
    const Curved = () => (<G transform="translate(3.65 2.75)">
      ...
      <Path d="M.5,0V6.041" transform="translate(7.51 7.226)" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" strokeWidth={strokeWidth}/>
      <Path d="M4.69,2.355,2.345,0,0,2.355" transform="translate(5.665 7.227)" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" strokeWidth={strokeWidth}/>
    </G>);
    switch (set) {
        case 'bold':
            return <Bold />;
