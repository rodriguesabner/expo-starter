...
const ChevronUpCircle = ({ color, secondaryColor, strokeWidth, opacity, set, }) => {
    const Bold = () => (<G transform="translate(2 2)">
      <Path d="M10,20A10,10,0,1,1,20,10l0,.28A10,10,0,0,1,10,20ZM10,9.02h0l2.94,2.949a.746.746,0,0,0,1.06.01.751.751,0,0,0,.225-.539A.729.729,0,0,0,14,10.92L10.53,7.43a.747.747,0,0,0-1.06,0L6,10.92a.7.7,0,0,0-.22.52.747.747,0,0,0,.22.54.758.758,0,0,0,.529.216.733.733,0,0,0,.531-.226L10,9.021Z" transform="translate(0 0)" fill={color}/>
    </G>);
    const Bulk = () => (<G transform="translate(22 22) rotate(180)">
    ...
    const Light = () => (<G transform="translate(22 22) rotate(180)">
    ...
    const Broken = () => (<G transform="translate(2 22) rotate(-90)">
    ...
    const TwoTone = () => (<G transform="translate(22 22) rotate(180)">
    ...
    const Curved = () => (<G transform="translate(22 22) rotate(180)">
